                          ...
                          itemBuilder: (_, index) {
                            ...
                            return GestureDetector(
                              onTap: (){
                                ...
                                data.status=="completada"?null:showModalBottomSheet(
                                    context: context,
                                    isDismissible: true,
                                    ...
                                    builder: (context) {
                                      return CreateNoteBottomSheet(width: width, formKey: formKey, noteController: noteController,allowEdit: true,note: data);
                                    });
                              },
                              child: Container(
